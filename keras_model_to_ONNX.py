...
model.save('cifar_model_20epochs.h5') 
#Load The saved model 
from tensorflow.keras.models import load_model
loaded_keras_model = load_model('cifar_model_20epochs.h5')
...
onnx.save(onnx_model, 'cifar10_onnx_20epochs.onnx')
...
session = onnxruntime.InferenceSession("cifar10_onnx_20epochs.onnx")
